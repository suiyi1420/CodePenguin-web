...
export default [
    ...
    routes: [
      ...
      },
      {
        ...
        routes: [
          {
            path: '/',
            redirect: '/system/class/list',
          },
          {
            name: 'class',
            icon: 'PartitionOutlined',
            path: '/system/class/classList',
          ...
          },
          {
            name: 'classSubject',
            icon: 'PartitionOutlined',
            path: '/system/class/classSubject',
          ...
          },
          {
            name: 'classStudent',
            icon: 'PartitionOutlined',
            path: '/system/class/classStudent',
...

      {
        ...
        routes: [
          {
            path: '/',
            redirect: '/system/subject/subjectlist',
          },
          {
            name: 'subject',
            icon: 'PartitionOutlined',
            path: '/system/subject/subjectlist',
          ...
          },
          {
            name: 'subjectInfo',
            icon: 'PartitionOutlined',
            path: '/system/subject/subjectInfo',
            routes: [
              {
                name: 'subjectInfo',
                icon: 'PartitionOutlined',
              ...
              },
              {
                name: 'subsection',
                icon: 'PartitionOutlined',
                path: '/system/subject/subjectInfo/subsection',
                component: 'system/subject/pages/subsection/index',
                access: 'authorize',
                wrappers: ['@/components/KeepAlive'],
                KeepAlive: true,
                title: 'menu.title.subjectInfo',
  ...
  {
    path: '/video_pdf',
    component: 'system/video/VideoPdf',
  },
  {
    component: './404',
  },
