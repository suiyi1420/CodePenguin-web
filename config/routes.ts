  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        icon: 'PartitionOutlined',
        path: '/system/class',
        component: 'system/class/index',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.class',
      },
      {
        name: 'classSubject',
        icon: 'PartitionOutlined',
        path: '/system/classSubject',
        component: 'system/class/pages/classInfo/index',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.classSubject',
      },
      {
        name: 'classStudent',
        icon: 'PartitionOutlined',
        path: '/system/classStudent',
        component: 'system/class/pages/student/index',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.classStudent',
      },
      {
        name: 'subject',
        icon: 'PartitionOutlined',
        ...
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.subject',
      },
      {
        name: 'subjectInfo',
        icon: 'PartitionOutlined',
        path: '/system/subjectInfo',
        component: 'system/subject/pages/subjectInfo/index',
        access: 'authorize',
        wrappers: ['@/components/KeepAlive'],
        KeepAlive: true,
        title: 'menu.title.subjectInfo',
      },
      // {
      //   name: 'dict',
      //   icon: 'PartitionOutlined',
